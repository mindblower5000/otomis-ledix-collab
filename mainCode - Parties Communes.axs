...
*/
		CHAR	phantomButtonGPDID_ON[10]	// GPD ON
		CHAR	phantomButtonGPDID_OFF[10]	// GPD OFF

		CHAR	phantomButtonAllID_ON[10]	// ALL ON
		CHAR	phantomButtonAllID_OFF[10]	// ALL OFF
		
		CHAR	phantomButtonID_ONOFF[10]	// ON/OFF
		CHAR	phantomButtonID_1[10]		// Scene#1
		CHAR	phantomButtonID_2[10]		// Scene#2
		CHAR	phantomButtonID_3[10]		// Scene#3
		CHAR	phantomButtonID_4[10]		// Scene#4
		CHAR	phantomButtonID_Raise[10]	// Raise
		CHAR	phantomButtonID_Lower[10]	// Lower
			
		CHAR	phantomLedID_ONOFF[10]		// ON/OFF
		CHAR	phantomLedID_1[10]			// Scene#1
		CHAR	phantomLedID_2[10]			// Scene#2
		CHAR	phantomLedID_3[10]			// Scene#3
		CHAR	phantomLedID_4[10]			// Scene#4	

		CHAR	LEDFeedbackPhantom[20]

		CHAR	LightSceneLevel
...
/*		CHAR	musiqueButtonID[10]
		...
		CHAR	MUMR_loadID[10]
*/
		CHAR	phantomButtonShadesOpenID[10]	// Open Shades
		CHAR	phantomButtonShadesStopID[10]	// Stop Shades
		CHAR	phantomButtonShadesCloseID[10]	// Close Shades

		CHAR	phantomButtonBlackoutOpenID[10]	// Open Blackout
		CHAR	phantomButtonBlackoutStopID[10]	// Stop Blackout
		CHAR	phantomButtonBlackoutCloseID[10]	// Close Blackout
...
DEFINE_VARIABLE
	...
	//Lighting
	CONSTANT INTEGER l_ad_SceneLevel			= 301
	...
	CONSTANT INTEGER l_l_SceneLevel				= 301
	...
	PERSISTENT _ZONE zones[EFFECTIVE_NB_ZONES]
...
#WARN 'FOR LOCAL TEST COMMENT Otomis_LutronQSX_comm'
...
DEFINE_FUNCTION UpdateViewState(INTEGER etage_index)
{
	...
	{	    
	    ...
	    activityViewState[Etage_SS][GetChannelByZoneActivity(Z_1__SS_Palier_es, IND_LIGHT)] 	= (zones[Z_1__SS_Palier_es].LEDFeedbackPhantom[ 1])							
	    ...
	    activityViewState[Etage_SS][GetChannelByZoneActivity(Z_2__SS_Vestiaire, IND_LIGHT)] 	= (zones[Z_2__SS_Vestiaire].LEDFeedbackPhantom[ 1]) 							
	    ...
	    activityViewState[Etage_SS][GetChannelByZoneActivity(Z_3__SS_Tisanerie, IND_LIGHT)] 	= (zones[Z_3__SS_Tisanerie].LEDFeedbackPhantom[ 1]) 							
	    ...
	    activityViewState[Etage_SS][GetChannelByZoneActivity(Z_4__SS_Bain_Japo, IND_LIGHT)] 	= (zones[Z_4__SS_Bain_Japo].LEDFeedbackPhantom[ 1])					
	    //activityViewState[Etage_SS][GetChannelByZoneActivity(Z_4__SS_Bain_Japo, IND_AC)] 		= (?CONDITION)					
	    ...
	    activityViewState[Etage_SS][GetChannelByZoneActivity(Z_5__SS_Hammam___, IND_LIGHT)] 	= (zones[Z_5__SS_Hammam___].LEDFeedbackPhantom[ 1]) 			
	    ...
	    activityViewState[Etage_SS][GetChannelByZoneActivity(Z_6__SS_Sauna____, IND_LIGHT)]		= (zones[Z_6__SS_Sauna____].LEDFeedbackPhantom[ 1])			
	    ...
	    activityViewState[Etage_SS][GetChannelByZoneActivity(Z_7__SS_Shiseido_, IND_LIGHT)] 	= (zones[Z_7__SS_Shiseido_].LEDFeedbackPhantom[ 1]) 					
	    ...
	    activityViewState[Etage_SS][GetChannelByZoneActivity(Z_8__SS_Douches_b, IND_LIGHT)] 	= (zones[Z_8__SS_Douches_b].LEDFeedbackPhantom[ 1]) 					
	...
	CASE Etage_RDC: 
	{
	    ...
	    activityViewState[Etage_RDC][GetChannelByZoneActivity(Z_11_R0_Accueil_P, IND_LIGHT)] 	= (zones[Z_11_R0_Accueil_P].LEDFeedbackPhantom[ 1])								
	    ...
	    activityViewState[Etage_RDC][GetChannelByZoneActivity(Z_12_R0_Grand_Sal, IND_LIGHT)] 	= (zones[Z_12_R0_Grand_Sal].LEDFeedbackPhantom[ 1]) 								
	    ...
	    activityViewState[Etage_RDC][GetChannelByZoneActivity(Z_13_R0_SalleAM__, IND_LIGHT)] 	= (zones[Z_13_R0_SalleAM__].LEDFeedbackPhantom[ 1])							 
	    ...
	    activityViewState[Etage_RDC][GetChannelByZoneActivity(Z_14_R0_Restauran, IND_LIGHT)] 	= (zones[Z_14_R0_Restauran].LEDFeedbackPhantom[ 1]) 								
	    ...
	    activityViewState[Etage_RDC][GetChannelByZoneActivity(Z_15_R0_Atelier_d, IND_LIGHT)] 	= (zones[Z_15_R0_Atelier_d].LEDFeedbackPhantom[ 1])				 		
	    ...
	    activityViewState[Etage_RDC][GetChannelByZoneActivity(Z_16_R0_Jardin___, IND_LIGHT)] 	= (zones[Z_16_R0_Jardin___].LEDFeedbackPhantom[ 1])	
	    ...
	    activityViewState[Etage_RDC][GetChannelByZoneActivity(Z_17_R0_Bar_ext__, IND_LIGHT)] 	= (zones[Z_17_R0_Bar_ext__].LEDFeedbackPhantom[ 1])	
	    ...
	    activityViewState[Etage_RDC][GetChannelByZoneActivity(Z_18_R0_Palier_et, IND_LIGHT)] 	= (zones[Z_18_R0_Palier_et].LEDFeedbackPhantom[ 1])	
	...
	CASE Etage_R1: 
	{
	    ...
	    activityViewState[Etage_R1][GetChannelByZoneActivity(Z_19_R1_Salle_Eif, IND_LIGHT)] 	= (zones[Z_19_R1_Salle_Eif].LEDFeedbackPhantom[ 1])	
	    ...
	    activityViewState[Etage_R1][GetChannelByZoneActivity(Z_20_R1_Salle_Tro, IND_LIGHT)] 	= (zones[Z_20_R1_Salle_Tro].LEDFeedbackPhantom[ 1])		
	    ...
	    activityViewState[Etage_R1][GetChannelByZoneActivity(Z_21_R1_Sanitaire, IND_LIGHT)] 	= (zones[Z_21_R1_Sanitaire].LEDFeedbackPhantom[ 1])			 
						
	    //Pallier et Escaliers       		
	    activityViewState[Etage_R1][GetChannelByZoneActivity(Z_22_R1_Pallier_e, IND_CONTROL)] 	= 0 	
	    activityViewState[Etage_R1][GetChannelByZoneActivity(Z_22_R1_Pallier_e, IND_LIGHT)] 	= (zones[Z_22_R1_Pallier_e].LEDFeedbackPhantom[ 1])		
	    ...
	    activityViewState[Etage_R1][GetChannelByZoneActivity(Z_23_R1_Terrasse, IND_LIGHT)] 		= (zones[Z_23_R1_Terrasse].LEDFeedbackPhantom[ 1])			
	    ...
	    activityViewState[Etage_R1][GetChannelByZoneActivity(Z_24_R1_BureauMme, IND_LIGHT)] 	= (zones[Z_24_R1_BureauMme].LEDFeedbackPhantom[ 1]) 		
	    ...
	    activityViewState[Etage_R1][GetChannelByZoneActivity(Z_25_R1_Pallier_P, IND_LIGHT)] 	= (zones[Z_25_R1_Pallier_P].LEDFeedbackPhantom[ 1])	
	...
	*/
	...
	CASE Etage_R5: 
	{
	    ...
	    activityViewState[Etage_R5][GetChannelByZoneActivity(Z_26_R5_Visions_d, IND_LIGHT)] 	= (zones[Z_26_R5_Visions_d].LEDFeedbackPhantom[ 1])		
	    ...
	    activityViewState[Etage_R5][GetChannelByZoneActivity(Z_27_R5_Pigeonnie, IND_LIGHT)] 	= (zones[Z_27_R5_Pigeonnie].LEDFeedbackPhantom[ 1])			
...
DEFINE_FUNCTION Scenarios(DEV dvTP, CHAR zone[], CHAR audioName[50], INTEGER etage, INTEGER act_index)
{
    ...
    //Use UpdateViewState for sync UI values
    //activityViewState[etage][act_index] = (activityViewState[etage][act_index]  == 0)
	SEND_COMMAND vdvLutron, "'K:P:',zones[GetZoneIdByName(zone)].phantomButtonID_ONOFF"
}
...
DEFINE_EVENT
	...
	DATA_EVENT[dvAMX]
	{
		...
		{			
			...
			TIMELINE_CREATE(TIMELINE_DEFINE_PROGRAM_LUTRON_CUSTOM, DEFINE_PROGRAM_TIMES, 1, TIMELINE_RELATIVE, TIMELINE_REPEAT)
...
#IF_DEFINED COMPIL_ALARM_CLOCK
	...
	//-----------------------------------------------------------------------------		
		...
		//-----------------------------------------------------------------------------
		UpdateViewState(Etage_SS)
		wait 50  UpdateViewState(Etage_RDC)
		wait 100  UpdateViewState(Etage_R1)
		wait 150  UpdateViewState(Etage_R2)
		wait 200  UpdateViewState(Etage_R3)
		wait 250  UpdateViewState(Etage_R4)
		wait 300  UpdateViewState(Etage_R5)
