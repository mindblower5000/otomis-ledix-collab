PROGRAM_NAME='Lutron_Custom_Chambres'
/*
...
DEFINE_FUNCTION lutronInit(DEV vdvLutron)
{
	...
	SEND_COMMAND vdvLutron, "'INIT:LOAD:', '1', ':',  'DND_301',				':', 	rooms[5].DND_loadID, ':', 	CHAMBRE,':NON_DIM'"
	SEND_COMMAND vdvLutron, "'INIT:LOAD:', '2', ':',  'MUMR_301',				':', 	rooms[5].MUMR_loadID, ':', 	CHAMBRE,':NON_DIM'"
...
*/		SEND_COMMAND vdvLutron, "'K:S:L:',rooms[num].phantomLedBedID_ONOFF"
		...
		SEND_COMMAND vdvLutron, "'K:S:L:',rooms[num].windowsOpenedLedID"
//	}
...
DEFINE_FUNCTION LedFeedbackAnalysis (CHAR lutron_ID[], CHAR state)
{
	...
	for(num=1;num<=NB_ROOMS;num++)
	{
		...
		{
			IF(state == 0)
				SEND_COMMAND ls_TPTabRooms[num], "'^SHO-',itoa(l_ad_SceneLevel[BEDROOM]),',0'"
			ELSE IF((rooms[num].LEDFeedbackPhantom[2] == 0 ) && 
					(rooms[num].LEDFeedbackPhantom[3] == 0 ) && 
					(rooms[num].LEDFeedbackPhantom[4] == 0 ) && 
					(rooms[num].LEDFeedbackPhantom[5] == 0 ))
				SEND_COMMAND ls_TPTabRooms[num], "'^SHO-',itoa(l_ad_SceneLevel[BEDROOM]),',0'"
		...
		{
			IF((rooms[num].LEDFeedbackPhantom[2] == 0 ) && (state == 1))
			{
				rooms[num].LightSceneLevel[BEDROOM] = 50
				SEND_COMMAND ls_TPTabRooms[num], "'^SHO-',itoa(l_ad_SceneLevel[BEDROOM]),',1'"
				SEND_LEVEL ls_TPTabRooms[num], l_l_SceneLevel[BEDROOM], rooms[num].LightSceneLevel[BEDROOM]
			}
		...
		{
			IF((rooms[num].LEDFeedbackPhantom[3] == 0 ) && (state == 1))
			{
				rooms[num].LightSceneLevel[BEDROOM] = 50
				SEND_COMMAND ls_TPTabRooms[num], "'^SHO-',itoa(l_ad_SceneLevel[BEDROOM]),',1'"
				SEND_LEVEL ls_TPTabRooms[num], l_l_SceneLevel[BEDROOM], rooms[num].LightSceneLevel[BEDROOM]
		...
		{
			IF((rooms[num].LEDFeedbackPhantom[4] == 0 ) && (state == 1))
			{
				rooms[num].LightSceneLevel[BEDROOM] = 50
				SEND_COMMAND ls_TPTabRooms[num], "'^SHO-',itoa(l_ad_SceneLevel[BEDROOM]),',1'"
				SEND_LEVEL ls_TPTabRooms[num], l_l_SceneLevel[BEDROOM], rooms[num].LightSceneLevel[BEDROOM]
		...
		{
			IF((rooms[num].LEDFeedbackPhantom[5] == 0 ) && (state == 1))
			{
				rooms[num].LightSceneLevel[BEDROOM] = 50
				SEND_COMMAND ls_TPTabRooms[num], "'^SHO-',itoa(l_ad_SceneLevel[BEDROOM]),',1'"
				SEND_LEVEL ls_TPTabRooms[num], l_l_SceneLevel[BEDROOM], rooms[num].LightSceneLevel[BEDROOM]
		...
		{
			IF(state == 0)
				SEND_COMMAND ls_TPTabRooms[num], "'^SHO-',itoa(l_ad_SceneLevel[BATHROOM]),',0'"
			ELSE IF((rooms[num].LEDFeedbackPhantom[7] == 0 ) && 
					(rooms[num].LEDFeedbackPhantom[8] == 0 ) && 
					(rooms[num].LEDFeedbackPhantom[9] == 0 ) && 
					(rooms[num].LEDFeedbackPhantom[10] == 0 ))
				SEND_COMMAND ls_TPTabRooms[num], "'^SHO-',itoa(l_ad_SceneLevel[BATHROOM]),',0'"
		...
		{
			IF((rooms[num].LEDFeedbackPhantom[7] == 0 ) && (state == 1))
			{
				rooms[num].LightSceneLevel[BATHROOM] = 50
				SEND_COMMAND ls_TPTabRooms[num], "'^SHO-',itoa(l_ad_SceneLevel[BATHROOM]),',1'"
				SEND_LEVEL ls_TPTabRooms[num], l_l_SceneLevel[BATHROOM], rooms[num].LightSceneLevel[BATHROOM]
			}
		...
		{
			IF((rooms[num].LEDFeedbackPhantom[8] == 0 ) && (state == 1))
			{
				rooms[num].LightSceneLevel[BATHROOM] = 50
				SEND_COMMAND ls_TPTabRooms[num], "'^SHO-',itoa(l_ad_SceneLevel[BATHROOM]),',1'"
				SEND_LEVEL ls_TPTabRooms[num], l_l_SceneLevel[BATHROOM], rooms[num].LightSceneLevel[BATHROOM]
		...
		{
			IF((rooms[num].LEDFeedbackPhantom[9] == 0 ) && (state == 1))
			{
				rooms[num].LightSceneLevel[BATHROOM] = 50
				SEND_COMMAND ls_TPTabRooms[num], "'^SHO-',itoa(l_ad_SceneLevel[BATHROOM]),',1'"
				SEND_LEVEL ls_TPTabRooms[num], l_l_SceneLevel[BATHROOM], rooms[num].LightSceneLevel[BATHROOM]
		...
		{
			IF((rooms[num].LEDFeedbackPhantom[10] == 0 ) && (state == 1))
			{
				rooms[num].LightSceneLevel[BATHROOM] = 50
				SEND_COMMAND ls_TPTabRooms[num], "'^SHO-',itoa(l_ad_SceneLevel[BATHROOM]),',1'"
				SEND_LEVEL ls_TPTabRooms[num], l_l_SceneLevel[BEDROOM], rooms[num].LightSceneLevel[BATHROOM]
			}
		...
		ELSE IF(lutron_ID == rooms[num].windowsOpenedLedID)
		{
			rooms[num].windowsOpened = state
			break
		}
	}
}
DEFINE_FUNCTION ButtonFeedbackAnalysis (CHAR lutron_ID[], CHAR state)
{
	...
	for(num=1;num<=NB_ROOMS;num++)
	{
		IF(lutron_ID == rooms[num].musiqueButtonID)
		{
			...
			{
				DO_PUSH(a_TPTabRooms[num],a_ch_AudioPwr[BATHROOM])
			}
			ELSE
			{
				IF(rooms[num].lastZoneAudioActivity[BEDROOM] != 'Off')
				{
					DO_PUSH(a_TPTabRooms[num],a_ch_AudioLink)
				}
				ELSE
				{
					DO_PUSH(a_TPTabRooms[num],a_ch_AudioSrc[13])		// Player#1
				}
			}
...
{
	[ls_TPTabRooms[num], l_ch_Light[3]] = (rooms[num].LEDFeedbackPhantom[ 1])
	[ls_TPTabRooms[num], l_ch_Light[4]] = (rooms[num].LEDFeedbackPhantom[ 2])
	[ls_TPTabRooms[num], l_ch_Light[5]] = (rooms[num].LEDFeedbackPhantom[ 3])
	[ls_TPTabRooms[num], l_ch_Light[6]] = (rooms[num].LEDFeedbackPhantom[ 4])
	[ls_TPTabRooms[num], l_ch_Light[7]] = (rooms[num].LEDFeedbackPhantom [5])
                                                                     
	[ls_TPTabRooms[num], l_ch_Light[10]] = (rooms[num].LEDFeedbackPhantom[ 6])
	[ls_TPTabRooms[num], l_ch_Light[11]] = (rooms[num].LEDFeedbackPhantom[ 7])
	[ls_TPTabRooms[num], l_ch_Light[12]] = (rooms[num].LEDFeedbackPhantom[ 8])
	[ls_TPTabRooms[num], l_ch_Light[13]] = (rooms[num].LEDFeedbackPhantom[ 9])
	[ls_TPTabRooms[num], l_ch_Light[14]] = (rooms[num].LEDFeedbackPhantom[10])
}
			...
			SWITCH (shadeName)
			{
				CASE 'Shades':
				{
					IF(rooms[num].windowsOpened)
						SEND_COMMAND dvTP, '^PPN-Windows Opened'
...
BUTTON_EVENT[ls_TPTabRooms, l_ch_Light]
{
	PUSH:
	{
		LOCAL_VAR char num
		...
		SWITCH (cmd)
		{
			...
			CASE  2: // ALL OFF
			{
				SEND_COMMAND BUTTON.INPUT.DEVICE, "'^SHO-',itoa(l_ad_SceneLevel[BEDROOM]),',0'"
				SEND_COMMAND BUTTON.INPUT.DEVICE, "'^SHO-',itoa(l_ad_SceneLevel[BATHROOM]),',0'"
			}
			
			CASE  3: // ON/OFF	BEDROOM
				SEND_COMMAND BUTTON.INPUT.DEVICE, "'^SHO-',itoa(l_ad_SceneLevel[BEDROOM]),',0'"
			...
			{
				rooms[num].LightSceneLevel[BEDROOM] = 50
				SEND_COMMAND BUTTON.INPUT.DEVICE, "'^SHO-',itoa(l_ad_SceneLevel[BEDROOM]),',1'"
				SEND_LEVEL BUTTON.INPUT.DEVICE, l_l_SceneLevel[BEDROOM], rooms[num].LightSceneLevel[BEDROOM]
			}
				
			CASE  8: // Raise
			{
				IF(rooms[num].LightSceneLevel[BEDROOM] < 96)
				{
					rooms[num].LightSceneLevel[BEDROOM] = rooms[num].LightSceneLevel[BEDROOM] + 5
					SEND_LEVEL BUTTON.INPUT.DEVICE, l_l_SceneLevel[BEDROOM], rooms[num].LightSceneLevel[BEDROOM]
				}
			}
			...
			CASE  9: // Lower
			{
				IF(rooms[num].LightSceneLevel[BEDROOM] > 4)
				{
					rooms[num].LightSceneLevel[BEDROOM] = rooms[num].LightSceneLevel[BEDROOM] - 5
					SEND_LEVEL BUTTON.INPUT.DEVICE, l_l_SceneLevel[BEDROOM], rooms[num].LightSceneLevel[BEDROOM]
				}
			...
			{
				rooms[num].LightSceneLevel[BATHROOM] = 50
				SEND_COMMAND BUTTON.INPUT.DEVICE, "'^SHO-',itoa(l_ad_SceneLevel[BATHROOM]),',1'"
				SEND_LEVEL BUTTON.INPUT.DEVICE, l_l_SceneLevel[BATHROOM], rooms[num].LightSceneLevel[BATHROOM]
			}
			
			CASE 15: // Raise
			{
				IF(rooms[num].LightSceneLevel[BATHROOM] < 96)
				{
					rooms[num].LightSceneLevel[BATHROOM] = rooms[num].LightSceneLevel[BATHROOM] + 5
					SEND_LEVEL BUTTON.INPUT.DEVICE, l_l_SceneLevel[BATHROOM], rooms[num].LightSceneLevel[BATHROOM]
				}
			}
			...
			CASE 16: // Lower
			{
				IF(rooms[num].LightSceneLevel[BATHROOM] > 4)
				{
					rooms[num].LightSceneLevel[BATHROOM] = rooms[num].LightSceneLevel[BATHROOM] - 5
					SEND_LEVEL BUTTON.INPUT.DEVICE, l_l_SceneLevel[BATHROOM], rooms[num].LightSceneLevel[BATHROOM]
				}
	...
	HOLD[10,REPEAT]:
	{
		...
		SWITCH (cmd)
		{
			CASE  8: // Raise
			{
				IF(rooms[num].LightSceneLevel[BEDROOM] < 96)
				{
					SEND_COMMAND vdvLutron, "'K:P:',rooms[num].phantomButtonBedID_Raise"	// Raise
			...
			CASE  9: // Lower
			{
				IF(rooms[num].LightSceneLevel[BEDROOM] > 4)
				{
					SEND_COMMAND vdvLutron, "'K:P:',rooms[num].phantomButtonBedID_Lower"	// Lower
			...
			CASE 15: // Raise
			{
				IF(rooms[num].LightSceneLevel[BATHROOM] < 96)
				{
					SEND_COMMAND vdvLutron, "'K:P:',rooms[num].phantomButtonBathID_Raise"	// Raise
			...
			CASE 16: // Lower
			{
				IF(rooms[num].LightSceneLevel[BATHROOM] > 4)
				{
					SEND_COMMAND vdvLutron, "'K:P:',rooms[num].phantomButtonBathID_Lower"	// Lower
...
BUTTON_EVENT[i_TPTabRooms, i_ch_Service]
{
	PUSH:
	{
		LOCAL_VAR char num
